...
export function t(theme: Theme) {
    ...
    return {
        ...
        cardInner: isDark ? "bg-slate-800/30 border-slate-700/50" : "bg-zinc-50 border-zinc-200/60",
        inputBg: isDark ? "bg-slate-800 border-slate-700 text-white placeholder-slate-500" : "bg-zinc-50 border-zinc-200 text-zinc-800 placeholder-zinc-400",
        selectBg: isDark ? "bg-slate-800 border-slate-700 text-white" : "bg-white border-zinc-200 text-zinc-800",

        // Text  
        textPrimary: isDark ? "text-white" : "text-zinc-900",
        textSecondary: isDark ? "text-slate-400" : "text-zinc-600",
        textMuted: isDark ? "text-slate-500" : "text-zinc-500",
        textHeading: isDark ? "text-white" : "text-zinc-900",

        // Sidebar
        sidebarText: isDark ? "text-slate-400" : "text-zinc-600",
        sidebarHover: isDark ? "hover:bg-slate-800 hover:text-white" : "hover:bg-zinc-100 hover:text-zinc-900",
