...
export function t(theme: Theme) {
    ...
    return {
        ...
        inputBg: isDark ? "bg-slate-800 border-slate-700 text-white placeholder-slate-500" : "bg-slate-50 border-slate-200 text-slate-800 placeholder-slate-400",
        selectBg: isDark ? "bg-slate-800 border-slate-700 text-white" : "bg-white border-slate-200 text-slate-800",

        // Text  
        textPrimary: isDark ? "text-white" : "text-slate-800",
        textSecondary: isDark ? "text-slate-400" : "text-slate-500",
        textMuted: isDark ? "text-slate-500" : "text-slate-400",
        textHeading: isDark ? "text-white" : "text-slate-800",

        // Sidebar
        sidebarText: isDark ? "text-slate-400" : "text-slate-500",
        sidebarHover: isDark ? "hover:bg-slate-800 hover:text-white" : "hover:bg-slate-100 hover:text-slate-800",
